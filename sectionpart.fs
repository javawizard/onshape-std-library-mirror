...
import(path : "onshape/std/holepropagationtype.gen.fs", version : "2878.0");
import(path : "onshape/std/holeAttribute.fs", version : "2878.0");
...
import(path : "onshape/std/jogPolygons.fs", version : "2878.0");
