...
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1218.0");
...
import(path : "onshape/std/extrude.fs", version : "1218.0");
import(path : "onshape/std/feature.fs", version : "1218.0");
import(path : "onshape/std/holeAttribute.fs", version : "1218.0");
