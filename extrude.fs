...
export import(path : "onshape/std/boundingtype.gen.fs", version : "370.0");
export import(path : "onshape/std/query.fs", version : "370.0");
export import(path : "onshape/std/tool.fs", version : "370.0");

// Features using manipulators must export manipulator.fs.
export import(path : "onshape/std/manipulator.fs", version : "370.0");

// Imports used internally
import(path : "onshape/std/boolean.fs", version : "370.0");
import(path : "onshape/std/booleanHeuristics.fs", version : "370.0");
...
import(path : "onshape/std/draft.fs", version : "370.0");
