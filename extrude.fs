...
export import(path : "onshape/std/extrudeCommon.fs", version : "1511.0");
...
import(path : "onshape/std/booleanHeuristics.fs", version : "1511.0");
...
import(path : "onshape/std/drafttype.gen.fs", version : "1511.0");
