...
export import(path : "onshape/std/extrudeCommon.fs", version : "2473.0");
export import(path : "onshape/std/flatOperationType.fs", version : "2473.0");
...
import(path : "onshape/std/drafttype.gen.fs", version : "2473.0");
...
import(path : "onshape/std/sheetMetalInFlat.fs", version : "2473.0");
