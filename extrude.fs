...
export import(path : "onshape/std/boundingtype.gen.fs", version : "736.0");
...
import(path : "onshape/std/booleanHeuristics.fs", version : "736.0");
...
import(path : "onshape/std/draft.fs", version : "736.0");
