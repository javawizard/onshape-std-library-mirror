...
import(path : "onshape/std/geomOperations.fs", version : "1618.0");
import(path : "onshape/std/manipulator.fs", version : "1618.0");
...
import(path : "onshape/std/smreliefstyle.gen.fs", version : "1618.0");
