...
export import(path : "onshape/std/curveextensionendcondition.gen.fs", version : "2345.0");
export import(path : "onshape/std/curveextensionshape.gen.fs", version : "2345.0");
