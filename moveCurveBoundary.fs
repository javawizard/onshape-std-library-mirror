...
export import(path : "onshape/std/curveextensionendcondition.gen.fs", version : "2780.0");
export import(path : "onshape/std/curveextensionshape.gen.fs", version : "2780.0");
