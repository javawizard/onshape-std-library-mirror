...
export import(path : "onshape/std/booleanoperationtype.gen.fs", version : "2837.0");

import(path : "onshape/std/debug.fs", version : "2837.0");
import(path : "onshape/std/feature.fs", version : "2837.0");
import(path : "onshape/std/featureList.fs", version : "2837.0");
...
import(path : "onshape/std/variable.fs", version : "2837.0");
