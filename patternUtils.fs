...
export import(path: "onshape/std/patternCommon.fs", version : "1378.0");

// Most patterns use these
export import(path : "onshape/std/boolean.fs", version : "1378.0");
export import(path : "onshape/std/containers.fs", version : "1378.0");
export import(path : "onshape/std/evaluate.fs", version : "1378.0");
export import(path : "onshape/std/feature.fs", version : "1378.0");
export import(path : "onshape/std/featureList.fs", version : "1378.0");
export import(path : "onshape/std/valueBounds.fs", version : "1378.0");

import(path : "onshape/std/mathUtils.fs", version : "1378.0");
import(path : "onshape/std/sheetMetalPattern.fs", version : "1378.0");
