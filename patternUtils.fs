...
export import(path: "onshape/std/patternCommon.fs", version : "2491.0");
...
import(path : "onshape/std/formedUtils.fs", version : "2491.0");
import(path : "onshape/std/mathUtils.fs", version : "2491.0");
import(path : "onshape/std/sheetMetalPattern.fs", version : "2491.0");
