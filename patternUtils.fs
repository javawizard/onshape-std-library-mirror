...
export import(path: "onshape/std/patternCommon.fs", version : "1403.0");
...
import(path : "onshape/std/sheetMetalPattern.fs", version : "1403.0");
import(path : "onshape/std/sheetMetalUtils.fs", version : "1403.0");
import(path : "onshape/std/topologyUtils.fs", version : "1403.0");
