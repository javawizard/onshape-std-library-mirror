...
import(path : "onshape/std/bridgingCurve.fs", version : "2780.0");
...
import(path : "onshape/std/frameAttributes.fs", version : "2780.0");
import(path : "onshape/std/instantiator.fs", version : "2780.0");
...
import(path : "onshape/std/tabReferences.fs", version : "2780.0");
...
export import(path : "onshape/std/profilecontrolmode.gen.fs", version : "2780.0");
