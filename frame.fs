...
import(path : "onshape/std/frameAttributes.fs", version : "2892.0");
import(path : "onshape/std/instantiator.fs", version : "2892.0");
...
export import(path : "onshape/std/profilecontrolmode.gen.fs", version : "2892.0");
