...
import(path : "onshape/std/bridgingCurve.fs", version : "2796.0");
...
import(path : "onshape/std/frameAttributes.fs", version : "2796.0");
...
export import(path : "onshape/std/profilecontrolmode.gen.fs", version : "2796.0");
