...
import(path : "onshape/std/debug.fs", version : "2221.0");
...
import(path : "onshape/std/primitives.fs", version : "2221.0");
import(path : "onshape/std/sheetMetalUtils.fs", version : "2221.0");
import(path : "onshape/std/splitpart.fs", version : "2221.0");
