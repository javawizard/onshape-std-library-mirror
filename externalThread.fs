...
export import(path : "onshape/std/chamfertype.gen.fs", version : "2144.0");
export import(path : "onshape/std/hole.fs", version : "2144.0");
export import(path : "onshape/std/holeAttribute.fs", version : "2144.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "2144.0");
export import(path : "onshape/std/moveFace.fs", version : "2144.0");
export import(path : "onshape/std/query.fs", version : "2144.0");
export import(path : "onshape/std/tool.fs", version : "2144.0");
...
import(path : "onshape/std/debug.fs", version : "2144.0");
...
import(path : "onshape/std/holetables.gen.fs", version : "2144.0");
import(path : "onshape/std/primitives.fs", version : "2144.0");
import(path : "onshape/std/sheetMetalUtils.fs", version : "2144.0");
import(path : "onshape/std/splitpart.fs", version : "2144.0");
