...
export import(path : "onshape/std/chamfertype.gen.fs", version : "2384.0");
...
import(path : "onshape/std/primitives.fs", version : "2384.0");
import(path : "onshape/std/sheetMetalUtils.fs", version : "2384.0");
import(path : "onshape/std/splitpart.fs", version : "2384.0");
