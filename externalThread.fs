...
export import(path : "onshape/std/chamfertype.gen.fs", version : "2770.0");
...
export import(path : "onshape/std/tool.fs", version : "2770.0");
...
import(path : "onshape/std/primitives.fs", version : "2770.0");
