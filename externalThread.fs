...
export import(path : "onshape/std/chamfertype.gen.fs", version : "2155.0");
export import(path : "onshape/std/hole.fs", version : "2155.0");
export import(path : "onshape/std/holeAttribute.fs", version : "2155.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "2155.0");
...
import(path : "onshape/std/lookupTablePath.fs", version : "2155.0");
import(path : "onshape/std/holetables.gen.fs", version : "2155.0");
import(path : "onshape/std/primitives.fs", version : "2155.0");
import(path : "onshape/std/sheetMetalUtils.fs", version : "2155.0");
import(path : "onshape/std/splitpart.fs", version : "2155.0");
