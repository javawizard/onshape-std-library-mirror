...
export import(path : "onshape/std/chamfertype.gen.fs", version : "1977.0");
...
import(path : "onshape/std/primitives.fs", version : "1977.0");
import(path : "onshape/std/sheetMetalUtils.fs", version : "1977.0");
import(path : "onshape/std/splitpart.fs", version : "1977.0");
