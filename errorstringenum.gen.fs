...
export enum ErrorStringEnum
{
    ...
    MATE_INVALID_MATE,
    MATEPOINT_INVALID_MATE,
    MATE_TWO_MATEPOINTS_NEEDED,
    MATEPOINTS_ON_SAME_OCCURRENCE,
    MATE_OVERDEFINED,
    MATE_INCONSISTENT,
    ...
    PART_QUERY_FAILED,
    PART_QUERY_MULTI,
    MATEPOINT_QUERY_FAILED,
    MATEPOINT_QUERY_ORIGIN_FAILED,
    MATEPOINT_QUERY_AXIS_FAILED,
    MATEPOINT_QUERY_CSYS_FAILED,
    ...
    MATEPOINT_OWNER_PART_NOT_RESOLVED,
