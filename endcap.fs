...
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "2878.0");
import(path : "onshape/std/chamfer.fs", version : "2878.0");
import(path : "onshape/std/containers.fs", version : "2878.0");
import(path : "onshape/std/cutlistMath.fs", version : "2878.0");
...
import(path : "onshape/std/frameUtils.fs", version : "2878.0");
import(path : "onshape/std/fillet.fs", version : "2878.0");
...
import(path : "onshape/std/splitpart.fs", version : "2878.0");
