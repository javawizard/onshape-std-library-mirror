...
import(path : "onshape/std/attributes.fs", version : "369.0");
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "369.0");
...
import(path : "onshape/std/manipulator.fs", version : "369.0");
import(path : "onshape/std/sketch.fs", version : "369.0");
import(path : "onshape/std/smobjecttype.gen.fs", version : "369.0");
import(path : "onshape/std/sheetMetalAttribute.fs", version : "369.0");
...
export import(path : "onshape/std/sheetMetalBend.fs", version : "369.0");
...
*/
annotation { "Feature Type Name" : "smFlange",
             "Manipulator Change Function" : "flangeManipulatorChange" }
export const smFlange = defineFeature(function(context is Context, id is Id, definition is map)
    precondition
    {
