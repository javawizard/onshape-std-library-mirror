...
import(path : "onshape/std/booleanaccuracy.gen.fs", version : "1311.0");
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1311.0");
...
import(path : "onshape/std/smobjecttype.gen.fs", version : "1311.0");
