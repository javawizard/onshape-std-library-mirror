...
import(path : "onshape/std/booleanaccuracy.gen.fs", version : "1605.0");
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1605.0");
...
import(path : "onshape/std/manipulator.fs", version : "1605.0");
import(path : "onshape/std/query.fs", version : "1605.0");
import(path : "onshape/std/sheetMetalAttribute.fs", version : "1605.0");
import(path : "onshape/std/smobjecttype.gen.fs", version : "1605.0");
