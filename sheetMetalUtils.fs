...
import(path : "onshape/std/booleanaccuracy.gen.fs", version : "2641.0");
...
import(path : "onshape/std/errorstringenum.gen.fs", version : "2641.0");
...
import(path : "onshape/std/smobjecttype.gen.fs", version : "2641.0");
