...
import(path : "onshape/std/compositeCurve.fs", version : "2878.0");
...
import(path : "onshape/std/loft.fs", version : "2878.0");
import(path : "onshape/std/moveCurveBoundary.fs", version : "2878.0");
