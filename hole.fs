...
import(path : "onshape/std/cylinderCast.fs", version : "1660.0");
import(path : "onshape/std/evaluate.fs", version : "1660.0");
import(path : "onshape/std/feature.fs", version : "1660.0");
import(path : "onshape/std/holetables.gen.fs", version : "1660.0");
import(path : "onshape/std/lookupTablePath.fs", version : "1660.0");
import(path : "onshape/std/mathUtils.fs", version : "1660.0");
import(path : "onshape/std/revolve.fs", version : "1660.0");
...
export import(path : "onshape/std/holeAttribute.fs", version : "1660.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "1660.0");
