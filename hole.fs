...
import(path : "onshape/std/boolean.fs", version : "1691.0");
...
export import(path : "onshape/std/holeAttribute.fs", version : "1691.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "1691.0");
