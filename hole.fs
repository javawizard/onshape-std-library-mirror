...
import(path : "onshape/std/box.fs", version : "1867.0");
import(path : "onshape/std/clashtype.gen.fs", version : "1867.0");
...
export import(path : "onshape/std/holeAttribute.fs", version : "1867.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "1867.0");
