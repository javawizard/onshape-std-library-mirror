...
import(path : "onshape/std/attributes.fs", version : "1389.0");
import(path : "onshape/std/boolean.fs", version : "1389.0");
import(path : "onshape/std/boundingtype.gen.fs", version : "1389.0");
import(path : "onshape/std/box.fs", version : "1389.0");
import(path : "onshape/std/clashtype.gen.fs", version : "1389.0");
import(path : "onshape/std/containers.fs", version : "1389.0");
import(path : "onshape/std/coordSystem.fs", version : "1389.0");
import(path : "onshape/std/curveGeometry.fs", version : "1389.0");
import(path : "onshape/std/cylinderCast.fs", version : "1389.0");
import(path : "onshape/std/evaluate.fs", version : "1389.0");
import(path : "onshape/std/feature.fs", version : "1389.0");
import(path : "onshape/std/holetables.gen.fs", version : "1389.0");
import(path : "onshape/std/lookupTablePath.fs", version : "1389.0");
import(path : "onshape/std/mathUtils.fs", version : "1389.0");
import(path : "onshape/std/revolve.fs", version : "1389.0");
import(path : "onshape/std/sheetMetalAttribute.fs", version : "1389.0");
import(path : "onshape/std/sheetMetalUtils.fs", version : "1389.0");
import(path : "onshape/std/sketch.fs", version : "1389.0");
...
export import(path : "onshape/std/holeAttribute.fs", version : "1389.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "1389.0");
export import(path : "onshape/std/holeUtils.fs", version : "1389.0");
