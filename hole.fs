...
import(path : "onshape/std/clashtype.gen.fs", version : "1758.0");
...
export import(path : "onshape/std/holeAttribute.fs", version : "1758.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "1758.0");
