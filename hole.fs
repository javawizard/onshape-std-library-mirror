...
import(path : "onshape/std/boundingtype.gen.fs", version : "1977.0");
import(path : "onshape/std/box.fs", version : "1977.0");
import(path : "onshape/std/clashtype.gen.fs", version : "1977.0");
...
export import(path : "onshape/std/holeAttribute.fs", version : "1977.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "1977.0");
