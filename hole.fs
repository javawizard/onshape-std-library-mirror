...
export import(path : "onshape/std/holeAttribute.fs", version : "1711.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "1711.0");
