...
import(path : "onshape/std/revolve.fs", version : "901.0");
...
import(path : "onshape/std/holetables.gen.fs", version : "901.0");
export import(path : "onshape/std/holesectionfacetype.gen.fs", version : "901.0");
import(path : "onshape/std/lookupTablePath.fs", version : "901.0");
import(path : "onshape/std/cylinderCast.fs", version : "901.0");
import(path : "onshape/std/curveGeometry.fs", version : "901.0");
import(path : "onshape/std/attributes.fs", version : "901.0");
export import(path : "onshape/std/holeAttribute.fs", version : "901.0");
export import(path : "onshape/std/holeUtils.fs", version : "901.0");
