...
export import(path : "onshape/std/error.fs", version : "369.0");
export import(path : "onshape/std/geomOperations.fs", version : "369.0");
...
import(path : "onshape/std/transform.fs", version : "369.0");
