...
export import(path : "onshape/std/error.fs", version : "370.0");
export import(path : "onshape/std/geomOperations.fs", version : "370.0");
...
import(path : "onshape/std/transform.fs", version : "370.0");
