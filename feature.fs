...
export import(path : "onshape/std/error.fs", version : "2130.0");
export import(path : "onshape/std/geomOperations.fs", version : "2130.0");
export import(path : "onshape/std/query.fs", version : "2130.0");
export import(path : "onshape/std/uihint.gen.fs", version : "2130.0");

// Imports used internally
import(path : "onshape/std/containers.fs", version : "2130.0");
import(path : "onshape/std/math.fs", version : "2130.0");
import(path : "onshape/std/recordpatterntype.gen.fs", version : "2130.0");
...
import(path : "onshape/std/tabReferences.fs", version : "2130.0");
