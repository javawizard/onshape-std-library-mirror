...
export import(path : "onshape/std/topologymatchtype.gen.fs", version : "1930.0");
/* opCreateCurvesOnFace uses enumerations from FaceCurveCreationType */
export import(path : "onshape/std/facecurvecreationtype.gen.fs", version : "1930.0");
/* opDraft uses enumerations from DraftType */
export import(path : "onshape/std/drafttype.gen.fs", version : "1930.0");
/* opExtendSheet uses enumerations from ExtendSheetBoundingType */
export import(path : "onshape/std/extendsheetboundingtype.gen.fs", version : "1930.0");
/* opExtractSurface uses enumerations from ExtractSurfaceRedundancyType */
export import(path : "onshape/std/extractsurfaceredundancytype.gen.fs", version : "1930.0");
/* opExtrude uses enumerations from BoundingType */
export import(path : "onshape/std/boundingtype.gen.fs", version : "1930.0");
...
export import(path : "onshape/std/geometriccontinuity.gen.fs", version : "1930.0");
...
export import(path : "onshape/std/splitoperationkeeptype.gen.fs", version : "1930.0");
/* opWrap uses enumerations from WrapType */
export import(path : "onshape/std/wraptype.gen.fs", version : "1930.0");
