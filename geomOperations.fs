...
export import(path : "onshape/std/bodydraftconcaverepairtype.gen.fs", version : "2625.0");
export import(path : "onshape/std/bodydraftcornertype.gen.fs", version : "2625.0");
export import(path : "onshape/std/bodydraftmatchfacetype.gen.fs", version : "2625.0");
export import(path : "onshape/std/bodydraftselectiontype.gen.fs", version : "2625.0");
/* opBoolean uses enumerations from TopologyMatchType */
export import(path : "onshape/std/topologymatchtype.gen.fs", version : "2625.0");
/* opCreateCurvesOnFace uses enumerations from FaceCurveCreationType */
export import(path : "onshape/std/facecurvecreationtype.gen.fs", version : "2625.0");
/* opDraft uses enumerations from DraftType */
export import(path : "onshape/std/drafttype.gen.fs", version : "2625.0");
/* opExtendSheet uses enumerations from ExtendSheetBoundingType */
export import(path : "onshape/std/extendsheetboundingtype.gen.fs", version : "2625.0");
/* opExtractSurface uses enumerations from ExtractSurfaceRedundancyType */
export import(path : "onshape/std/extractsurfaceredundancytype.gen.fs", version : "2625.0");
/* opExtrude uses enumerations from BoundingType */
export import(path : "onshape/std/boundingtype.gen.fs", version : "2625.0");
/* opFillet uses enumerations from FilletCrossSection */
export import(path : "onshape/std/filletcrosssection.gen.fs", version : "2625.0");
/* opFillSurface uses enumerations from GeometricContinuity */
export import(path : "onshape/std/geometriccontinuity.gen.fs", version : "2625.0");
...
export import(path : "onshape/std/splitoperationkeeptype.gen.fs", version : "2625.0");
/* opWrap uses enumerations from WrapType */
export import(path : "onshape/std/wraptype.gen.fs", version : "2625.0");
