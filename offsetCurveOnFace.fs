...
import(path : "onshape/std/approximationUtils.fs", version : "2641.0");
export import(path : "onshape/std/movecurveboundarytype.gen.fs", version : "2641.0");
export import(path : "onshape/std/offsetcurvetype.gen.fs", version : "2641.0");
