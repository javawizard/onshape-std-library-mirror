...
export import(path : "onshape/std/entityinferencetype.gen.fs", version : "2321.0");
export import(path : "onshape/std/mateconnectoraxistype.gen.fs", version : "2321.0");
export import(path : "onshape/std/origincreationtype.gen.fs", version : "2321.0");
export import(path : "onshape/std/rotationtype.gen.fs", version : "2321.0");
    ...
    precondition
    {
        ...
        if (definition.allowOwnerEntity)
        {
            ...
            if (definition.requireOwnerPart)
            {
                ...
                annotation { "Name" : "Select owner entity", "Filter" : EntityType.BODY && (BodyType.SOLID || GeometryType.MESH || BodyType.SHEET || BodyType.WIRE)
