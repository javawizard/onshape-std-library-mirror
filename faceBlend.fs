...
export import(path : "onshape/std/faceblendcrosssection.gen.fs", version : "✨");
export import(path : "onshape/std/faceblendpropagation.gen.fs", version : "✨");
export import(path : "onshape/std/faceblendtrimtype.gen.fs", version : "✨");
export import(path : "onshape/std/faceblendcrosssectionshape.gen.fs", version : "✨");
