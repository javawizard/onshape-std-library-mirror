...
import(path : "onshape/std/primitives.fs", version : "2559.0");
...
export import(path : "onshape/std/extendendtype.gen.fs", version : "2559.0");
export import(path : "onshape/std/extendsheetshapetype.gen.fs", version : "2559.0");
