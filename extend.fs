...
import(path : "onshape/std/primitives.fs", version : "1793.0");
...
export import(path : "onshape/std/extendendtype.gen.fs", version : "1793.0");
export import(path : "onshape/std/extendsheetshapetype.gen.fs", version : "1793.0");
