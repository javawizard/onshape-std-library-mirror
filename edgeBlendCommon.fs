...
import(path : "onshape/std/blendcontroltype.gen.fs", version : "2945.0");
import(path : "onshape/std/chamfermethod.gen.fs", version : "2945.0");
import(path : "onshape/std/chamfertype.gen.fs", version : "2945.0");
...
import(path : "onshape/std/filletcrosssection.gen.fs", version : "2945.0");
