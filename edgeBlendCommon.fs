...
import(path : "onshape/std/blendcontroltype.gen.fs", version : "2506.0");
import(path : "onshape/std/chamfermethod.gen.fs", version : "2506.0");
import(path : "onshape/std/chamfertype.gen.fs", version : "2506.0");
import(path : "onshape/std/containers.fs", version : "2506.0");
import(path : "onshape/std/edgeconvexitytype.gen.fs", version : "2506.0");
import(path : "onshape/std/evaluate.fs", version : "2506.0");
import(path : "onshape/std/feature.fs", version : "2506.0");
import(path : "onshape/std/filletcrosssection.gen.fs", version : "2506.0");
