...
import(path : "onshape/std/holeAttribute.fs", version : "2679.0");
import(path : "onshape/std/holepropagationtype.gen.fs", version : "2679.0");
...
import(path : "onshape/std/registerSheetMetalFormedTools.fs", version : "2679.0");
