...
import(path : "onshape/std/holeAttribute.fs", version : "2368.0");
import(path : "onshape/std/holepropagationtype.gen.fs", version : "2368.0");
import(path : "onshape/std/math.fs", version : "2368.0");
import(path : "onshape/std/patternCommon.fs", version : "2368.0");
