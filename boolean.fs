...
export import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1301.0");
...
import(path : "onshape/std/patternCommon.fs", version : "1301.0");
import(path : "onshape/std/primitives.fs", version : "1301.0");
