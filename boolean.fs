...
export import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1224.0");
export import(path : "onshape/std/query.fs", version : "1224.0");
export import(path : "onshape/std/tool.fs", version : "1224.0");
...
import(path : "onshape/std/patternCommon.fs", version : "1224.0");
import(path : "onshape/std/primitives.fs", version : "1224.0");
