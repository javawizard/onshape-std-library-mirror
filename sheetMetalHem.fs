...
import(path : "onshape/std/booleanaccuracy.gen.fs", version : "1324.0");
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1324.0");
...
import(path : "onshape/std/error.fs", version : "1324.0");
