...
import(path : "onshape/std/booleanaccuracy.gen.fs", version : "1511.0");
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1511.0");
...
import(path : "onshape/std/error.fs", version : "1511.0");
...
import(path : "onshape/std/transform.fs", version : "1511.0");
