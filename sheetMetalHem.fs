...
import(path : "onshape/std/booleanoperationtype.gen.fs", version : "1024.0");
...
import(path : "onshape/std/rollSurface.fs", version : "1024.0");
...
import(path : "onshape/std/uihint.gen.fs", version : "1024.0");
